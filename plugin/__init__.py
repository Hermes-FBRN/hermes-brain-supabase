...
class SupabaseMem0MemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "admin_token", "description": "Trusted control-plane token. Only direct-DB main agents should have this.", "secret": True, "required": False, "env_var": "SUPABASE_BRAIN_ADMIN_TOKEN"},
            {"key": "agent_token", "description": "Limited token for future client-agent API/MCP proxy access. Direct-DB trusted agents do not need this.", "secret": True, "required": False, "env_var": "SUPABASE_BRAIN_AGENT_TOKEN"},
            {"key": "allowed_lobes", "description": "Comma-separated lobes this trusted direct-DB deployment may access; use server-side permissions for client agents", "default": "nucleus", "env_var": "SUPABASE_BRAIN_ALLOWED_LOBES"},
